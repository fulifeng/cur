...
def early_fusion_cv():
    ...
    model_paras = {'lam_i': 50.0, 'thres': 0.004}
    model = early_fusion.early_fusion(model_paras, feature_fname_fname, final_list_fname, historical_ranking_list, hr_scale=2)
